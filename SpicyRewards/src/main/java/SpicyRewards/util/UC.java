...
public class UC {
    ...
    public static Texture getTexture(String folder, String name) {
        return TextureLoader.getTexture(SpicyRewards.makeImagePath(folder + "/" + name + ".png"));
    }

    public static TextureAtlas.AtlasRegion getTextureAtlas(String folder, String name) {
        return TextureLoader.getTextureAsAtlasRegion(SpicyRewards.makeImagePath(folder + "/" + name + ".png"));
    }
