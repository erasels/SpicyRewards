...
import static SpicyRewards.SpicyRewards.makeCardPath;
import static SpicyRewards.SpicyRewards.makeUIPath;
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                return getTexture("spicyRewardsResources/images/ui/missing_texture.png");
            }
        }
